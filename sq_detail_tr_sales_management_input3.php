<?php
  ...
  include("sq_detail_tr_sales_management_input4_data_set.php");  
?>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#confirm_okBtn").click(function(event) {
      ...
      //戻る処理の場合
      if (process == "return") {
        $("#input3").attr("action", "sq_detail_tr_sales_management_input2.php?sq_no="+<?= $sq_no ?>+"&process=detail&title=<?= $title ?>");
      }
    });
    ...
    $("#ok_okBtn").click(function(event) {
      ...
      if (process == "errExec") {
        //sq_class_input1へ移動
        $('#input3').attr('action', 'sq_detail_tr_sales_management_input1.php?title=<?= $title ?>');
      } else {
        //画面上変更なし
