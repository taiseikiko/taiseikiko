  ...
  <form class="row g-3" method="POST" name="inq_ent" enctype="multipart/form-data" id="input2">
      ...
      <tr>
        <td>
          <div class="field-row">
            ...
            <select name="size" class="input-res">
              <option value="">選択して下さい。</option>
            </select>
          </div>
        </td>
    ...
    <table style="width:auto;">
      ...
      <tr>
        <td>
          <div class="field-row">
            ...
            <input type="date" style="margin-left: 1rem;" min="2023-01-01" max="2028-12-31" name="entrant_set_date" value="" class="input-res" />
            <label class="common_label" for="entrant_set_comments">コメント</label>
            <textarea id="entrant_set_comments" style="margin-left: 1rem;" name="entrant_set_comments" rows="3" cols="120" class="textarea-res"></textarea>
          </div>
        </td>
      </tr>
      <tr style="height:10px;"></tr>
      ...
      <tr>
        <td>
          <div class="field-row">
            <label class="common_label" for="entrant">担当指定者</label>
            <select name="zkm_code" class="input-res">
              <option value="">選択して下さい。</option>
            </select>

            <label class="common_label" for="office_name">　　部署</label>
            <input type="text" style="width:370px;" name="office_name" class="readonlyText input-res" value="" readonly>

            <label class="common_label" for="office_position_name">　　役職</label>
            <input type="text" style="width:100px;" class="readonlyText input-res" name="office_position_name" value="" readonly>
          </div>
        </td>
      </tr>
      <tr style="height:10px;"></tr>
      ...
      <td>
        <div class="flex-container">
          <div>
            ...
            <button class="updateBtn" name="submit" value="update">更新</button>
          </div>
        </div>
      </td>
    </tr>
