          ...
          <tr>
            <td>
              <div class="field-row">
                ...
                <label class="common_label" for="dw_div1_1" style="margin-left:35px; margin-top:17px">標準</label>

                <input type="radio" id="dw_div1_2" name="dw_div1" value="2" <?php if ($dw_div1 == '2') { echo "checked"; } ?>>
                <label class="common_label" for="dw_div1_2" style="margin-top:17px">特殊</label>

                <input type="radio" id="dw_div1_3" name="dw_div1" value="3" <?php if ($dw_div1 == '2') { echo "checked"; } ?>>
                <label class="common_label" for="dw_div1_3" style="margin-top:17px">鋼板製</label>
                ...
                <label class="common_label" for="open_div1" style="margin-left:35px; margin-top:17px">公開</label>

                <input type="radio" id="open_div2" name="case_div" value="2" <?php if ($open_div == '2') { echo "checked"; } ?>>
                <label class="common_label" for="open_div2" style="margin-top:17px">非公開</label>
              </div>
            </td>
          </tr>
