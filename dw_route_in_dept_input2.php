...
include("header1.php");
include("dw_route_in_dept_input2_data_set.php");
?>
<main>
  <div class="pagetitle">
    <h3>部署内ルートマスター保守</h3>
...
<script src="assets/js/dw_route_in_dept_input_check.js"></script>
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#confirm_okBtn").click(function(event) {
      ...
      //戻る処理の場合
      if (process == "return") {
        $('#set-busyo-route').attr('action', 'dw_route_in_dept_input1.php');
      }
      //ヘッダ更新処理の場合
        ...
        $("#set-busyo-route").attr("action", "dw_route_in_dept_update.php");
      }
    });
