...
function cu_card_header_tr() {
    ...
    $sql = 'UPDATE card_header_tr SET 
                card_status=:card_status, 
                abort_person=:abort_person, 
                abort_date=:abort_date,
                abort_comments=:abort_comments, 
                upd_date=:upd_date
...
function cu_card_detail_tr() {
    global $pdo, $card_no, $sq_card_line_no, $type, $from, $today;
