...
include('dw_route_in_dept_input1_data_set.php');
include("header1.php");
?>
<main>
  <div class="pagetitle">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td style="text-align:center"><button id="updateBtn<?= $i ?>" class="updateBtn" data-dept="<?= $item['department_code'] ?>" data-emp="<?= $item['employee_code'] ?>" data-role="<?= $item['role'] ?>" name="process" value="update">更新</button></td>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(".createBtn").click(function() {
      $("#route_dept_form").attr("action", "dw_route_in_dept_input2.php");
    });
