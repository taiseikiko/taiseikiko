<table style="width:auto;">
  ...
  <tr>
    <td>
      <div class="field-row" style="margin-top: 10px;">
        <label class="common_label" style="text-align:center;" for="mitsumori">見積原価 </label>
  ...
  <tr>
    <td>
      <div class="field-row" style="margin-top: 10px;">
        ...
        <?php if ($title !== 'sm_confirm') { echo 'disabled style="background-color: #e6e6e6;"'; } ?>><?= $confirmor_comments ?></textarea>
      </div>
    </td>
  </tr>
  <?php
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#submit_upload1").click(function(){
      ...
      $("#input3").attr("action", "sq_attach_upload1.php?from=m1");
    })
    //見積定価のアップロードボタンを押下する場合
    $("#submit_upload2").click(function(){
      //sq_attach_upload1.phpへ移動する
      $("#input3").attr("action", "sq_attach_upload1.php?from=m2");
    })
