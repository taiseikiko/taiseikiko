<?php
  ...
  if(isset($_POST['process2'])) {
    ...
    if (isset($sq_detail_eng_datas) && !empty($sq_detail_eng_datas)) {
      $mail_to1 = $sq_detail_eng_datas['mail_to1'];
      $mail_to2 = $sq_detail_eng_datas['mail_to2'];
      $mail_to3 = $sq_detail_eng_datas['mail_to3'];
      $mail_to4 = $sq_detail_eng_datas['mail_to4'];
      $mail_to5 = $sq_detail_eng_datas['mail_to5'];
      $entrant_comments = $sq_detail_eng_datas['entrant_comments'];
      $confirmer_comments = $sq_detail_eng_datas['confirmer_comments'];
      $approver_comments = $sq_detail_eng_datas['approver_comments'];
    }
