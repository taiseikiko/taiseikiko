<?php
  ...
  if (isset($_POST['submit_entrant1'])) {
    ...
    try {
      ...
      entrant_cu_sq_detail_tr_engineering1($entrant_comments, $confirmor_comments, $approver_comments, $title);
  ...
  if (isset($_POST['submit_entrant2'])) {
    ...
    try {
      $pdo->beginTransaction();
      //テーブルID : sq_detail_tr_engineering / テーブル名称：営業依頼書・明細T/R_技術
      entrant_cu_sq_detail_tr_engineering2($entrant_comments, $confirmor_comments, $approver_comments, $mail_to1, $mail_to2, $mail_to3, $mail_to4, $mail_to5, $title);
  ...
  /*----------------------------------------------------------------入力画面の関数開始------------------------------------------------------------------------------------- */
  //テーブルID : sq_detail_tr_engineering / テーブル名称：営業依頼書・明細T/R_技術
  function entrant_cu_sq_detail_tr_engineering1($entrant_comments, $confirmor_comments, $approver_comments, $title) {
    global $pdo;
    global $today;
    global $sq_no;
    global $sq_line_no;
    ...
    if ($title == 'td_confirm') {
      ...
      $sql1 = "UPDATE sq_detail_tr_engineering SET confirmor=:confirmor, confirmor_comments=:confirmor_comments, confirm_date=:confirm_date, upd_date=:upd_date 
          WHERE sq_no=:sq_no AND sq_line_no=:sq_line_no";
    }
  ...
  function entrant_cu_sq_detail_tr_engineering2($entrant_comments, $confirmor_comments, $approver_comments, $mail_to1, $mail_to2, $mail_to3, $mail_to4, $mail_to5, $title) {
    global $pdo;
    global $today;
    global $sq_no;
    global $sq_line_no;
    ...
    if ($title == 'td_confirm') {
      ...
      $sql1 = "UPDATE sq_detail_tr_engineering SET confirmor=:confirmor, confirmor_comments=:confirmor_comments, confirm_date=:confirm_date, mail_to1=:mail_to1, 
          mail_to2=:mail_to2, mail_to3=:mail_to3, mail_to4=:mail_to4, mail_to5=:mail_to5, upd_date=:upd_date 
          WHERE sq_no=:sq_no AND sq_line_no=:sq_line_no";
    }
